...
export class MenuDataService {
    getMenuList() {
        return [
            ...
            {
                Label: 'About Us', Icon: 'fa-info-circle', RouterLink: '/home/aboutus', Childs: null, IsChildVisible: false
            },
            {
                Label: 'Contact Us', Icon: 'fa-envelope', RouterLink: '/home/contactus', Childs: null, IsChildVisible: false
            },
            {
